...
| 02 | Beezie | Rust – Solana(Anchor)| Solana Anchor marketplace for Metaplex Core NFTs - fixed-price listings via delegate-based escrow, up-front-funded bids in a program-owned escrow, and Metaplex Core royalty enforcement at settlement, with admin/operator moderation controls.| [CD Security](https://cdsecurity.site/) | TBA|⏳| 
