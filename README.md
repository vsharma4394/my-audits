...
| Contest | Category | Findings | Ranking | Report |
| --- | --- | --- | --- | --- |
| [**Union Finance**](https://audits.sherlock.xyz/contests/445) | Credit, undercollateralized lending | 4H | 🥇 1st Place | [View Report](contests/2024-07-union-finance.md) |
| [**Olas**](https://code4rena.com/audits/2024-05-olas) | Autonomous agents, tokenomics, staking | 1H / 4M *(3 solo)* | 🥈 2nd Place | [View Report](contests/2024-06-olas.md) |
| [**Tokensoft Distributor**](https://audits.sherlock.xyz/contests/285) | Token distribution, vesting | 1M | 🥈 2nd Place | [View Report](contests/2024-05-tokensoft.md) |
...
| --- | --- | --- | --- | --- | --- | --- |
| 01 | OlympusX (2nd follow-up) | Solidity – EVM (Uniswap v4) | Follow-up review of the deflationary yield protocol - custom Uniswap v4 hooks for dynamic taxation, epoch-based limit orders, and multi-channel revenue routing | [CD Security](https://cdsecurity.site/) | TBA |⏳|
| 02 | Beezie | Rust – Solana(Anchor)| Solana Anchor marketplace for Metaplex Core NFTs - fixed-price listings via delegate-based escrow, up-front-funded bids in a program-owned escrow, and Metaplex Core royalty enforcement at settlement, with admin/operator moderation controls.| [CD Security](https://cdsecurity.site/) | 1M/6L |[🧾](https://github.com/CDSecurity/audits/blob/main/audit%20reports/Beeize_Marketplace_Report.pdf)| 
| 03 | OlympusX (follow-up) | Solidity – EVM (Uniswap v4) | Follow-up review of the deflationary yield protocol -custom Uniswap v4 hooks for dynamic taxation, epoch-based limit orders, and multi-channel revenue routing | [CD Security](https://cdsecurity.site/) | 1H/2M/4L | [🧾](https://github.com/CDSecurity/audits/blob/main/audit%20reports/OlympusX_Followup_Report.pdf)  |
| 04 | OlympusX | Solidity – EVM (Uniswap v4) | Deflationary DeFi yield protocol featuring custom Uniswap v4 hooks for dynamic taxation, epoch-based limit orders, and a multi-channel revenue routing architecture | [CD Security](https://cdsecurity.site/) | 3H/4M/13L | [🧾](https://github.com/CDSecurity/audits/blob/main/audit%20reports/OlympusX_Report.pdf) |
| 05 | Ultra Market | Solidity – EVM | Leverage protocol enabling capital-efficient leveraged trading on prediction markets through an LP-funded vault | [CD Security](https://cdsecurity.site/) | 5H/2M/6L | [🧾](https://github.com/CDSecurity/audits/blob/main/audit%20reports/Ultra-Markets-report.pdf)  |
